...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/comprar_produto.css">
    ...
    <section id="conteudo1">
      ...
      <div class="informacoesProd">
        ...
        <div class="caracteristicas">
          <p id="de">De: <?php echo ("R$ ".number_format(($valorSemDesconto), 2, ',', ' ')); ?></p>
          <p id="por">Por: <span class="numeros"><?php echo ("R$ ".number_format(($preco), 2, ',', ' ')); ?></span></p>
          <p id="parcelas">
            Ou em até <span class="numerosCartao">10X</span> de <span class="numerosCartao"><?php echo ("R$ ".number_format(($preco/10), 2, ',', ' ')); ?></span> sem juros no cartão.
          </p>
          <p id="txtBoleto">
            Ou <span class="boleto"><?php echo ("R$ ".number_format(($precoComDescontoParaOBoleto), 2, ',', ' ')); ?></span> no Boleto Bancário à vista (<span class="boleto">5% de desconto</span>).
          </p>
          <form class="" action="carrinho.php?acao=add&id=<?php echo $id_produto; ?>" method="post">
            <img src="img/carrinho.png" id="imgCarrinho" alt="">
            <input type="submit" name="btnComprar" value="Comprar" class="btnComprar">
          </form>
        </div>

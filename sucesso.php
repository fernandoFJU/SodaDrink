    ...
    <section id="conteudo1">
      ...
      <div id="sucesso">
        <div class="terminar">
          ...
          <a href="boleto.php?venda=<?php echo $venda['ultimaVenda'];?>">
        ...
        <div class="infoPedido">
          <p id="txtImpressao">Para a impressão do boleto bancário, clique no botão <b>Imprimir Boleto</b> acima.</p>
          <div class="informacoesPed">
            ...
            <div class="linhas f">
              Forma de pagamento: <span id="forma">Boleto Bancário</span>
            </div>
          </div>
        </div>
